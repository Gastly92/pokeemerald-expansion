...
#define AI_FRAME_CEILING_STEVEN_MULTI_SMART_TRAINER             34 // +1: Batch S innate AI reads (Infiltrator/Skill Link/etc.); +1: Batch U side-wide AI reads (Aroma Veil/Flower Veil/Telepathy); +1: Tier 5.5 innate Mold Breaker adds an IsInnateActive check to IsMoldBreakerTypeAbility, which the AI runs; +1: Batch W2 grows the linear-scanned species_ability_overrides.c table (GetSpeciesAbility scans it on every ability lookup the AI does), tipping this most AI-intensive scenario over
