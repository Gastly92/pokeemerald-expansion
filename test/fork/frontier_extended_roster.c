...
static const u16 sSetShapeReviewedThroughDex = NATIONAL_DEX_ENAMORUS; // Gen 1-8 reviewed; Gen 9 next. KEEP IN SYNC with the twin in test/fork/innate_abilities.c
