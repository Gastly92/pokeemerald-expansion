...
static const u16 sSetShapeReviewedThroughDex = NATIONAL_DEX_ARCEUS; // Gen 1-4 reviewed; Gen 5 next. KEEP IN SYNC with the twin in test/fork/innate_abilities.c
