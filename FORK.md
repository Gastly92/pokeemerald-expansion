...
`DETERMINISTIC_ADDITIONAL_EFFECTS`, `DETERMINISTIC_HOLD_EFFECTS`, and
`DETERMINISTIC_ACCURACY_EVASION` (all enabled — see table). The general shape
