...
`DETERMINISTIC_ACCURACY_EVASION` (the last still in progress — its sleep→drowse and
50%→recharge conversions are not yet implemented; all enabled — see table). The general shape
