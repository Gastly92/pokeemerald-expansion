...
| Tier 5 — Bespoke/deferred | one-off | 11 | open (ordered 5.1–5.11; take top-down — 5.1 Mega Sol, 5.2 Quick Draw, 5.3 Comatose, 5.4 Magic Guard, 5.5 Mold Breaker, 5.6 Opportunist, 5.7 Mirror Armor, 5.8 Magic Bounce, 5.9 Dancer, 5.10 Flower Gift done; only 5.11 Aura Break left) |
| **Total** | | **133** | |
