...
| W8 | Batch L Intimidate all-innate (**split by dex**) | the ~40 sets that hardcoded Intimidate | ~40 | open (chunk **W8a done**: dex ≤ 237 — Arbok, Arcanine + Hisui, Tauros + Paldea trio, Gyarados, Granbull, Qwilfish, Hitmontop; fork chosen overrides Arbok→Poison Point, Tauros-Paldea→Sheer Force, Gyarados→Motor Drive, Granbull→Static, Hitmontop→No Guard, and free-real-slot repoints Arcanine/Hisui→Flash Fire, Tauros→Sheer Force, Qwilfish→Poison Point. Remaining: dex ≥ 262 — Mightyena, Masquerain, Mawile, Salamence, Staraptor, Luxray, Stoutland, Krookodile, Scrafty, Incineroar, Wyrdeer, Overqwil, Squawkabilly-Green, Mabosstiff) |
