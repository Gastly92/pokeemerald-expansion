...
| Tier 5 — Bespoke/deferred | one-off | 11 | open (ordered 5.1–5.11; take top-down — 5.1 Mega Sol, 5.2 Quick Draw, 5.3 Comatose, 5.4 Magic Guard, 5.5 Mold Breaker done) |
| **Total** | | **133** | |
...
| Y8 — Mold Breaker clones | Turboblaze, Teravolt | **Mold Breaker (Tier 5.5 — now DONE)** | **Unblocked** — Mold Breaker shipped its shared machinery (`IsMoldBreakerTypeAbility` innate clause). Y8 is now pure follow-on: add Reshiram/Zekrom (+ their Black/White Kyurem fusions) species data + two `IsInnateActive(battler, ABILITY_TERAVOLT/TURBOBLAZE)` lines beside the Mold Breaker clause. Do next. |
