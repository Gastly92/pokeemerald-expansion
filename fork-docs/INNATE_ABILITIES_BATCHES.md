...
| 23+ | Batch Y — Promoted-from-rejected clones (18, sub-groups Y1–Y8; Y1 cheapest, Y8 blocked on 5.5 Mold Breaker) | active/calc/trait, drivers exist | open (Y1 done: Chilling Neigh / Grim Neigh / Electromorphosis; Y2 done: Transistor / Dragon's Maw; Y3 done: Prism Armor / Shadow Shield / Neuroforce / Supreme Overlord; Y4 done: Full Metal Body / Mind's Eye; Y5 done: Purifying Salt / Good as Gold; Y6–Y8 open, interleave with Tier 5) |
...
| Y — Promoted-from-rejected clones | active/calc/trait (drivers exist) | 18 (see sub-groups) | open (Y1, Y2, Y3, Y4, Y5 done; Y6–Y8 open) |
