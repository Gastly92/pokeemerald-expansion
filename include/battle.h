...
struct PartyState
{
    ...
    // FORK: padding is upstream's; it shrinks by 1 for reachedPinchHp above. On conflict, take
    // upstream's padding value minus the fork bits declared here (the word must still total 32).
    u32 padding:4;
    u16 usedHeldItem;
};
