...
enum StringID
{
    ...
    // FORK: fork-owned string IDs stay last so this block is append-only and upstream's
    // additions above it always auto-merge. Keep in sync with gBattleStringsTable.
    STRINGID_HARVESTHPGAIN, // FORK: DETERMINISTIC_ABILITIES
    STRINGID_TYPEAFFINITYAWAKENED, // FORK: "Affinity" ability family
    STRINGID_HALOAPPEARED, // FORK: Halo ability
    STRINGID_COUNT
};
