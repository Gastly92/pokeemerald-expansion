...
// FORK: drives the Battle Frontier facility-guide intro escort. 0 = new game /
// before the reception-gate Scott scene; 1 = Scott scene done, greeter waiting
// outside to escort the player to the Battle Factory; 2 = escort finished, the
// permanent guide stands by the Factory. Repurposed from a free saved var.
#define VAR_FRONTIER_FACILITY_GUIDE                     0x40A8
