...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            TRUE                // FORK: always on for sandbox testing. Overworld debug menu to change flags, variables, giving Pokémon and more, accessed by holding R and pressing START while in the overworld by default.
...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               TRUE                // FORK: always on for sandbox testing. Enables a debug menu to use in battles by pressing the Select button.
