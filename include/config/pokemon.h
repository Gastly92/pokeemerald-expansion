...
#define P_SHOW_TERA_TYPE                 GEN_9       // FORK: enabled (was GEN_8). Since Gen 9, the Tera Type is shown on the summary screen (Info page, alongside the type icons) - relevant now that FEATURE_FREE_GIMMICKS lets any mon Terastallize.
