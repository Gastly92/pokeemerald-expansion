...
// SaveBlock2 configs
#define FREE_BATTLE_TOWER_E_READER          TRUE    // Frees up Battle Tower E-Reader data (188 bytes). FORK: reclaims SaveBlock2 space for the 6v6 Factory rentalMons array; unused in the Battle Frontier sandbox.
