...
#define SKIP_INTRO_TO_MAIN_MENU      FALSE   // If TRUE, boot skips the copyright logo, the regular intro and the title screen, going straight to the main menu (the RHH intro still plays if EXPANSION_INTRO is TRUE). Essential boot init (save loading, etc.) still runs.
