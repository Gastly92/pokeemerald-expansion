...
// FORK: fork-only new-game/boot flags. Upstream removed HQ_RANDOM from this
// spot (the SFC32 RNG is now unconditional). On conflict, keep these five flags
// and follow upstream for HQ_RANDOM rather than re-adding it.
