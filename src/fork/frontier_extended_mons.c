...
const struct TrainerMon gFrontierExtendedMons[] =
{
    ...
    // ---- Venusaur ----
    {
        ...
        .ability = ABILITY_THICK_FAT, // Overgrow + Chlorophyll now innate; chosen Thick Fat (slot-1 override)
        .nature = NATURE_BOLD,
    ...
    // ---- Skeledirge ----
    {
        ...
        .ability = ABILITY_CURSED_BODY, // Blaze+Unaware both innate; chosen Cursed Body via species_ability_overrides
        .nature = NATURE_BOLD,
        .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 4, 0),
        .teraType = TYPE_FAIRY,
        .ball = BALL_POKE,
