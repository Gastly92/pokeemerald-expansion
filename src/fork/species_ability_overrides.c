...
static const struct SpeciesAbilityOverride sSpeciesAbilityOverrides[] =
{
    ...
    { SPECIES_ARMALDO,             1, ABILITY_WATER_ABSORB },   // 348 Battle Armor + Swift Swim BOTH innate (all real abilities innate): empty slot 1 → Water Absorb, the ancient sea-floor fossil turns its 2x Water weakness into a heal
    ...
    { SPECIES_TORTERRA,            1, ABILITY_SAND_STREAM },     // 389 Overgrow (latched) + Shell Armor BOTH innate (all real abilities innate): empty slot 1 → Sand Stream, the continent turtle stirs earth (Ground-type, immune to its own sand chip)
    ...
    { SPECIES_SAMUROTT,            1, ABILITY_WATER_ABSORB },   // 503 Torrent (latched) + Shell Armor BOTH innate (all real abilities innate): empty slot 1 → Water Absorb, the sea-otter samurai drinks in Water attacks
    ...
    { SPECIES_TURTONATOR,          1, ABILITY_FLAME_BODY },     // 776 sole-Shell-Armor (innate): empty slot 1 → Flame Body, the explosive fire turtle's superheated shell burns on contact
