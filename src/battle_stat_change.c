...
static enum Ability GetInnateStatDropProtector(enum BattlerId battler, enum Stat stat, bool32 *fullProtection); // FORK: innate-aware stat-drop protection
...
static enum Ability GetInnateStatDropProtector(enum BattlerId battler, enum Stat stat, bool32 *fullProtection)
{
