...
static const struct SpeciesTierEntry sSpeciesTiers[] =
{
    ...
    { NATIONAL_DEX_KYUREM, TIER_LEGENDARY }, // Kyurem
    { NATIONAL_DEX_KELDEO, TIER_LEGENDARY }, // Keldeo
    { NATIONAL_DEX_MELOETTA, TIER_LEGENDARY }, // Meloetta
    { NATIONAL_DEX_GENESECT, TIER_LEGENDARY }, // Genesect
    { NATIONAL_DEX_DIANCIE, TIER_LEGENDARY }, // Diancie
    { NATIONAL_DEX_HOOPA, TIER_LEGENDARY }, // Hoopa
    { NATIONAL_DEX_MAGEARNA, TIER_LEGENDARY }, // Magearna
    { NATIONAL_DEX_VOLCANION, TIER_LEGENDARY }, // Volcanion
    ...
    { NATIONAL_DEX_MARSHADOW, TIER_LEGENDARY }, // Marshadow
    { NATIONAL_DEX_ZERAORA, TIER_LEGENDARY }, // Zeraora
    ...
    { NATIONAL_DEX_TERAPAGOS, TIER_MYTHICAL }, // 1024
    { NATIONAL_DEX_PECHARUNT, TIER_MYTHICAL }, // 1025
